...
const Album$json = const {
  ...
  '2': const [
    ...
    const {'1': 'photo', '3': 3, '4': 3, '5': 11, '6': '.Photo', '10': 'photo'},
  ],
};

/// Descriptor for `Album`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List albumDescriptor = $convert.base64Decode('CgVBbGJ1bRIOCgJpZBgBIAEoBVICaWQSFAoFdGl0bGUYAiABKAlSBXRpdGxlEhwKBXBob3RvGAMgAygLMgYuUGhvdG9SBXBob3Rv');
